    ...
    async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            if (typeof user === "object" && user !== null) {
                const urlPara = (user as JwtPayload & { urlPara: string })
                    .urlPara;
                ...
                announcements.forEach((a) => {
                    ...
                    if (a.endDate !== null && a.endDate !== undefined) {
                        ...
                        return res
                            .status(500)
                            .send(
                                "Internal error: End date of an announcement is undefined"
                            );
                    }
                ...
                if (overlaps) {
                    res.status(409).send(
                        "Announcement period overlaps with an existing announcement"
                    );
                } else {
            ...
            const serverLogMessage =
                "Error while trying to add new announcement";
...
router.get(
    ...
    async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            const serverLogMessage =
                "Error while trying to get all announcements";
...
router.post(
    ...
    async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            const serverLogMessage =
                "Error while trying to delete an announcement";
